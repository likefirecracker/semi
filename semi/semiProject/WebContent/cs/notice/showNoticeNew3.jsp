...
<body>
	...
	%>
				<input type="button" value="글목록" onclick="location.href='listNoticeNew.jsp?pageNum=<%=pageNum%>'">
			</td>
		</tr>
	</table>
	<%
	...
	%>
				<div >
					<a href="showNoticeNew.jsp?n_num=<%= n_after %>&pageNum=<%= pageNum %>" id="upPage">
						위 페이지&nbsp;PREV&nbsp;&nbsp;&nbsp;&nbsp;<%= n_title2 %>
					</a>
				</div>
	<%
	...
	%>
			<div >
				<a href="showNoticeNew.jsp?n_num=<%= n_before %>&pageNum=<%= notice.getBefore() %>" id="upPage">
